...
A projektünk elérhető a Microsoft Azure felhőszolgáltatáson keresztül az alábbi linken:  
\url{https://hephaistos-backend-c6c5ewhraedvgzex.germanywestcentral-01.\section*{Microsoft Azure Elérhetőség}
...
A Microsoft Azure segítségével biztosítjuk, hogy a Project Hephaistos alkalmazás megbízhatóan és hatékonyan szolgálja ki a felhasználók igényeit.websites.net/index.html}
\addcontentsline{toc}{section}{Elérhetőség}
\pagebreak
